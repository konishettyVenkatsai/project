...
{
	@Test
	public void DpcLogin() throws InterruptedException
	{
	...
	@Test
	public void DpcLogout() throws InterruptedException
	{
		System.setProperty("webdriver.chrome.driver", "F:\\Eclipse\\drivers\\chromedriver_win32\\chromedriver.exe");
	    ...
	    driver.findElement(By.xpath("/html/body/app-root/app-main-layout/app-header/nav/div/div[2]/ul[2]/li[5]/div[2]/div/ul/li/ul/li[2]/a")).click();
	    Thread.sleep(5000);
	    driver.close();
	}
}
